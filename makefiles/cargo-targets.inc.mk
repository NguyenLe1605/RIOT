...
ifneq (,$(filter gnrc_ipv6_ipsec,$(USEMODULE)))
  CARGO_OPTIONS += --features rust_riotmodules/riot-module-gnrc-ipv6-ipsec
endif
ifneq (,$(filter wireguard,$(USEMODULE)))
  CARGO_OPTIONS += --features rust_riotmodules/riot-module-wireguard
endif
